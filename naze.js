...
const nyoutube = ('© Fin\nWebsite :\nhttps://linktr.ee/fin222')  //ubah di config biar ngk emror
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                naze.sendMessage(m.chat, { image: { url: 'https://i.postimg.cc/Y0v0xpCM/lol.jpg' }, caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Jika ingin berdonasi silahkan scan gambar diatas*\n\n*Atau klik link dibawah ini*\n_https://saweria.co/Rimuru233_\n\n*Atau Transfer via*\n- *Gopay Dana Ovo Qris ShopeePay*\n Ke nomer berikut : 082261065144\n\n_Terima kasih bagi yang sudah donasi_` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('https://wa.me/6282261065144')
            }
            break
            case 'chat': {
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let jodoh = member[Math.floor(Math.random() * member.length)]
            let jawab = `Ciee yang Jadian💖 Jangan lupa Donasi Ke *Alfin*🗿
